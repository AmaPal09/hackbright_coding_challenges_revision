...
def say_hi(person_name): 
    print('Hi {}'.format(person_name))
...
def repeat_string(str1, times_num): 
    print(str1*times_num)
...
def write_letter(recipient_name, job_title, sender_name): 
    ...
    print(f"Dear {title_and_name}, I think you are amazing! Sincerely, {sender_name}")
